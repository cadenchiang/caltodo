...
"[project]/.claude/worktrees/claude-work/src/lib/gcal-displays.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.claude/worktrees/claude-work/src/lib/image-widget-presets.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.claude/worktrees/claude-work/src/lib/weather-displays.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.claude/worktrees/claude-work/src/lib/widget-types.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.claude/worktrees/claude-work/src/lib/font-options.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.claude/worktrees/claude-work/src/lib/clock-faces.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.claude/worktrees/claude-work/src/lib/notes-styles.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.claude/worktrees/claude-work/src/lib/extract-palette.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.claude/worktrees/claude-work/src/lib/board-layout-types.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/.claude/worktrees/claude-work/src/lib/board-templates.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function base(overrides) {
    return {
        ...
        titleTextColor: "",
        titleFontSize: "lg",
        coverHeight: __TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COVER_HEIGHT"],
        coverPositionY: __TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COVER_POSITION_Y"],
        updatedAt: Date.now(),
        ...overrides
    };
}
...
"[project]/.claude/worktrees/claude-work/src/lib/board-layout-sync.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function registerFlushListeners() {
    if (listenersRegistered || ("TURBOPACK compile-time value", "object") === "undefined") return;
...
"[project]/.claude/worktrees/claude-work/src/lib/board-layout-cache.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
/** Set of currently supported widget type strings. */ const SUPPORTED_TYPES = new Set(Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$widget$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WIDGET_REGISTRY"]));
function readPersistedLayout() {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    try {
        const raw = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEY"]);
        if (!raw) return null;
        ...
        if (parsed.boardEmoji && !parsed.boardEmoji.startsWith("lucide:") && /^[a-zA-Z0-9_-]+$/.test(parsed.boardEmoji)) {
            parsed.boardEmoji = "\u{1F4D6}";
        }
        // Sanitize corrupted boardDescription — reset to default if it looks like a URL
        if (typeof parsed.boardDescription === "string" && (parsed.boardDescription.startsWith("http://") || parsed.boardDescription.startsWith("https://"))) {
        ...
        if (parsed.coverHeight == null) parsed.coverHeight = __TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COVER_HEIGHT"];
        if (parsed.coverPositionY == null) parsed.coverPositionY = __TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COVER_POSITION_Y"];
        ...
        if (parsed.version === 2) {
            ...
            if (Array.isArray(lgLayout)) {
                parsed.layouts.lg = lgLayout.map((item)=>{
                    const widgetDef = parsed.widgets.find((w)=>w.id === item.i);
                    const reg = widgetDef ? __TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$widget$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WIDGET_REGISTRY"][widgetDef.type] : null;
                    const minW = reg?.minW ?? 1;
                    const newW = Math.max(Math.ceil(item.w * __TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NEW_LG_COLS"] / __TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OLD_LG_COLS"]), minW);
                    const newX = Math.round(item.x * __TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NEW_LG_COLS"] / __TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OLD_LG_COLS"]);
                    const clampedX = Math.min(newX, __TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NEW_LG_COLS"] - newW);
                    return {
                        ...item,
            ...
            try {
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEY"], JSON.stringify(parsed));
            } catch  {}
        }
        if (parsed.version !== __TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SCHEMA_VERSION"]) return null;
        // Filter out unsupported/legacy widget types
        const validWidgets = parsed.widgets.filter((w)=>SUPPORTED_TYPES.has(w.type));
        const removedIds = new Set(parsed.widgets.filter((w)=>!SUPPORTED_TYPES.has(w.type)).map((w)=>w.id));
        if (removedIds.size > 0) {
            parsed.widgets = validWidgets;
            for (const bp of Object.keys(parsed.layouts)){
                parsed.layouts[bp] = (parsed.layouts[bp] || []).filter((l)=>!removedIds.has(l.i));
            }
        }
        return parsed;
    } catch  {
...
function writeLayoutCache(data) {
    ...
    ;
    try {
        localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f2e$claude$2f$worktrees$2f$claude$2d$work$2f$src$2f$lib$2f$board$2d$layout$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEY"], JSON.stringify(data));
    } catch  {
...
//# sourceMappingURL=_claude_worktrees_claude-work_src_lib_169562f1._.js.map