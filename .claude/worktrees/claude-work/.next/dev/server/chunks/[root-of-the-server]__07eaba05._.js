...
"[project]/.claude/worktrees/claude-work/src/app/api/gcal/poll/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data } = await supabase.from("integration_credentials").select("gcal_events_updated_at").eq("user_id", user.id).single();
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07eaba05._.js.map