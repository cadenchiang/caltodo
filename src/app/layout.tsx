...
export const metadata: Metadata = {
  title: {
    default: "caltodo: sync your classes, never miss a deadline",
    template: "%s | caltodo",
  },
  description:
  ...
  // Favicon + Apple touch icon are generated by src/app/icon.tsx and
  // src/app/apple-icon.tsx (clean centered calendar-check on brand blue).
  appleWebApp: {
    capable: true,
