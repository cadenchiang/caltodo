...
export function getDefaultLayout(): {
  ...
  const lg: LayoutItem[] = [
    { i: "default-tasks", x: 0, y: 0, w: 2, h: 1, minW: 1, minH: 1 },
    { i: "default-clock", x: 2, y: 0, w: 2, h: 1, minW: 1, minH: 1 },
    { i: "default-weather", x: 4, y: 0, w: 2, h: 1, minW: 1, minH: 1 },
    { i: "default-notes", x: 6, y: 0, w: 2, h: 1, minW: 1, minH: 1 },
  ];
