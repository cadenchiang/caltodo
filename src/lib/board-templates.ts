...
export const BOARD_TEMPLATES: BoardTemplate[] = [
  ...
  },
  {
    ...
    description: "Links, notes, calendar, and weather — everything at a glance.",
    category: "popular",
    previewWidgets: ["quick-links", "notes", "google-calendar", "weather", "clock"],
    layout: base({
      ...
      layouts: {
        lg: [
          { i: "t-links", x: 0, y: 0, w: 2, h: 3 },
          { i: "t-notes", x: 2, y: 0, w: 3, h: 3 },
          { i: "t-gcal", x: 5, y: 0, w: 3, h: 3 },
          { i: "t-weather", x: 0, y: 3, w: 2, h: 2 },
          { i: "t-clock", x: 2, y: 3, w: 2, h: 2 },
        ],
        md: [
          { i: "t-links", x: 0, y: 0, w: 2, h: 3 },
          { i: "t-notes", x: 2, y: 0, w: 2, h: 3 },
          { i: "t-gcal", x: 0, y: 3, w: 3, h: 3 },
          { i: "t-weather", x: 3, y: 3, w: 1, h: 2 },
          { i: "t-clock", x: 0, y: 6, w: 2, h: 2 },
        ],
        sm: [
          { i: "t-links", x: 0, y: 0, w: 2, h: 3 },
          { i: "t-notes", x: 0, y: 3, w: 2, h: 3 },
          { i: "t-gcal", x: 0, y: 6, w: 2, h: 3 },
          { i: "t-weather", x: 0, y: 9, w: 2, h: 2 },
          { i: "t-clock", x: 0, y: 11, w: 2, h: 2 },
        ],
      },
    }),
  },
