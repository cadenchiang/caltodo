/**
 * Sound effects for chat messages using the Web Audio API.
 * Synthesizes iMessage-style send/receive tones without external audio files.
 * Sounds are short, subtle, and non-intrusive.
 */
