import { Plug, GraduationCap, Palette, Wrench, Bell, type LucideIcon } from "lucide-react";

/** Valid settings section identifiers. */
export type SettingsSectionId = "integrations" | "classes" | "notifications" | "appearance" | "advanced";
