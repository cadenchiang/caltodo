...
import { Inbox, CalendarDays, Settings, Sun, CalendarRange, Plus } from "lucide-react";
 ...
 * Contains Inbox, Calendar, a labelled Add button, and Settings, with
 * active state highlighting and aria-current. Includes safe-area padding
 * for the iPhone home indicator.
 *
 * Home (the widget board) and Chat are intentionally absent: both are
 * desktop-only surfaces. The proxy and MobileRouteGuard bounce direct
 * visits to those routes so the tab bar and the reachable routes agree.
 */
