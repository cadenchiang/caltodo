...
interface CalendarHeaderProps {
  ...
  onNextMonth: () => void;
  onToday: () => void;
  showGcalSync?: boolean;
  onGcalSync?: () => void;
}

/**
 * Calendar header with month/year display, navigation controls,
 * and optional Google Calendar sync button.
 *
 ...
 * @param showGcalSync - Whether to show the GCal sync button
 * @param onGcalSync - Callback when GCal sync button is clicked
 */
  ...
  return (
    <div className="flex items-center justify-between mb-5">
      <div className="flex items-center gap-3">
        ...
        {showGcalSync && onGcalSync && (
          <button
            onClick={onGcalSync}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg bg-white text-gray-700 border border-gray-200 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-700 transition-colors shadow-sm"
          >
            <svg width={14} height={14} viewBox="0 0 122.88 122.88" className="shrink-0">
