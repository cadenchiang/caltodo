  ...
  if (courses.length === 0) {
    return (
      <div className="h-full w-full flex flex-col items-center justify-center gap-1.5 p-3">
        <GraduationCap size={24} className="text-foreground/30" />
        <span className="text-xs text-foreground">No courses yet</span>
      </div>
    );
  }
            ...
            return (
              ...
              >
                ...
                <div className="px-2.5 py-2">
                  ...
                  <span className="text-xs text-foreground">{c.taskCount} tasks</span>
                </div>
              </button>
            );
          })}
