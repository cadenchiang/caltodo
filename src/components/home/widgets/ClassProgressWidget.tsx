  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-popover rounded-2xl shadow-2xl border border-border w-full max-w-md mx-4 animate-announce-card-in overflow-hidden max-h-[80vh] flex flex-col">
