/**
 * Inline Google Calendar logo SVG for brand recognition. Decorative: the
 * card's visible title carries the name.
 *
 * @param size - Icon dimensions in pixels (default 16)
 */
export default function GoogleCalendarIcon({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
