...
/**
 * Inline Google Calendar logo SVG for the callout section.
 */
...
export default function IntegrationsWelcomeModal() {
  ...
  return createPortal(
    ...
    >
      <div
        className={`bg-popover rounded-2xl shadow-2xl w-full max-w-sm mx-4 p-6 text-center ${cardClass}`}
      ...
      >
        ...
        {/* Title */}
        <h3
          className="text-lg font-semibold text-foreground mb-2 animate-drop-in"
        ...
        {/* Description */}
        <p
          className="text-sm text-muted-foreground mb-5 animate-drop-in"
        ...
        {/* Platform badges */}
        <div
          className="flex items-center justify-center gap-2 mb-4 animate-drop-in"
          style={{ animationDelay: "340ms" }}
        >
          <div className="bg-muted rounded-lg px-3 py-1.5 flex items-center gap-1.5">
            <img src="/bcourses-logo.png" alt="" className="w-4 h-4" />
            <span className="text-xs font-medium text-foreground">bCourses</span>
          </div>
          <div className="bg-muted rounded-lg px-3 py-1.5 flex items-center gap-1.5">
            <img src="/gradescope-logo.png" alt="" className="w-4 h-4" />
            <span className="text-xs font-medium text-foreground">Gradescope</span>
          </div>
          <div className="bg-muted rounded-lg px-3 py-1.5 flex items-center gap-1.5">
            <img src="/pensieve-logo.png" alt="" className="w-4 h-4" />
            <span className="text-xs font-medium text-foreground">Pensieve</span>
          </div>
        </div>

        {/* Google Calendar callout */}
        <div
          className="bg-muted/50 rounded-xl p-3.5 flex items-center gap-3 text-left mb-6 animate-drop-in"
