  ...
  return (
    <div className="flex flex-col gap-5 w-full">
      ...
      <button
        ...
        className="flex items-center justify-center gap-3 w-full px-4 py-3.5 rounded-xl bg-black text-white text-sm font-semibold animate-drop-in hover:scale-[1.05] active:scale-[0.97] transition-transform duration-200"
      >
        <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M9 3.58c1.321 0 2.508.454 3.44 1.345l2.582-2.58C13.463.891 11.426 0 9 0A8.997 8.997 0 00.957 4.958L3.964 6.29C4.672 4.163 6.656 2.58 9 3.58z" fill="white"/>
        </svg>
