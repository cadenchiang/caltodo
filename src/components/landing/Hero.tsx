      ...
      <main className="flex-1 flex flex-col items-center px-6 lg:px-10">
        ...
        <div className="min-h-[calc(100dvh-8rem)] sm:min-h-0 flex flex-col items-center justify-center sm:justify-start w-full">
          ...
          <Link
            ...
            className="px-6 sm:px-8 py-2 rounded-full bg-[#0071E3] text-white text-sm sm:text-base font-medium hover:bg-[#0077ED] transition-colors duration-200 mb-4 sm:mb-12"
          >
            Get caltodo free
          </Link>
