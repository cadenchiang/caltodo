      ...
      <nav className="sticky top-0 z-40 flex items-center justify-between px-4 py-3 sm:px-8 sm:py-4 backdrop-blur-xl bg-white/70">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Link
            ...
            className="px-4 py-1.5 text-xs sm:px-5 sm:py-2 sm:text-sm font-medium rounded-full bg-[#0071E3] text-white hover:bg-[#0077ED] transition-colors duration-200"
          >
            Get caltodo free
          </Link>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center px-6 lg:px-10">
        ...
        <div className="min-h-[calc(100dvh-8rem)] sm:min-h-0 flex flex-col items-center justify-center sm:justify-start w-full">
          ...
          <Link
            ...
            className="flex items-center gap-2 px-6 sm:px-8 py-2 rounded-full bg-[#0071E3] text-white text-sm sm:text-base font-medium hover:bg-[#0077ED] transition-colors duration-200 mb-4 sm:mb-12"
          >
            Get caltodo free
