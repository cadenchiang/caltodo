      ...
      <main className="flex flex-col items-center px-6 lg:px-10">
        ...
        <div className="flex items-center justify-center gap-5 sm:gap-7 mt-10 mb-6 animate-appear opacity-0 delay-300">
          ...
          <div className="group relative cursor-pointer">
            ...
            />
            <div className="pointer-events-none absolute left-1/2 -translate-x-1/2 top-full mt-3 w-52 rounded-lg bg-zinc-950 text-white text-xs leading-relaxed px-3.5 py-2.5 shadow-lg opacity-0 scale-95 transition-all duration-200 group-hover:opacity-100 group-hover:scale-100 z-50">
              <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-zinc-950 rotate-45" />
              Auto-sync all your bCourses assignments and due dates directly into your calendar.
            </div>
          </div>
          ...
          <div className="group relative cursor-pointer">
            ...
            <div className="pointer-events-none absolute left-1/2 -translate-x-1/2 top-full mt-3 w-52 rounded-lg bg-zinc-950 text-white text-xs leading-relaxed px-3.5 py-2.5 shadow-lg opacity-0 scale-95 transition-all duration-200 group-hover:opacity-100 group-hover:scale-100 z-50">
              <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-zinc-950 rotate-45" />
              Pull in Gradescope homework and exam deadlines so nothing slips through the cracks.
            </div>
          </div>
          ...
          <div className="group relative cursor-pointer">
            ...
            <div className="pointer-events-none absolute left-1/2 -translate-x-1/2 top-full mt-3 w-56 rounded-lg bg-zinc-950 text-white text-xs leading-relaxed px-3.5 py-2.5 shadow-lg opacity-0 scale-95 transition-all duration-200 group-hover:opacity-100 group-hover:scale-100 z-50">
              <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-zinc-950 rotate-45" />
              Export everything to Google Calendar with one click — see all your assignments right where you plan your day.
            </div>
          </div>
        </div>
