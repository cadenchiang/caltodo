...
export const FIELD_INPUT =
  "w-full px-3 py-2 rounded-lg border border-input-border bg-card text-foreground text-sm placeholder:text-subtle-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:border-input-border disabled:opacity-50 disabled:cursor-not-allowed";
